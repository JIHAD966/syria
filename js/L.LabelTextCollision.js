        ...
        .extend({
            ...
            _text : function(ctx, layer) {
                ...
                if (layer.options.text != undefined) {
                     ...
                     */
                    ctx.lineWidth = 3.0;
                    ctx.font = "18px 'Arial'";//_____________________________________________________________________________________________ Text seiz
                    ...
                    if (layer.options.textColor == undefined) {
                        ctx.fillStyle = "#F8F841";//F2F5A9 ; White: #FEFEFE ______________________________________________________________________________________Farbe
                    } else {
